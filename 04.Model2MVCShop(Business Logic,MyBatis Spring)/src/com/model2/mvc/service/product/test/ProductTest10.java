...
import mybatis.service.domain.Search;
import mybatis.service.domain.Product;
import mybatis.service.product.test.SqlSessionFactoryBean;
...
public class ProductTest10 {
	...
	public static void main(String[] args) throws Exception{
		...
		System.out.println(":: "+sqlSession.selectOne("ProductMapper10.getProduct",product.getProductId()) );
		System.out.println("\n");
